...
public interface Packet {
    ...
    static ByteBuffer getData(Packet p, xyz.wireway.protocol.PacketRegistry packetRegistry){
    ...
    static Packet read(ComposedBuffer buffer, xyz.wireway.protocol.PacketRegistry packetRegistry){
