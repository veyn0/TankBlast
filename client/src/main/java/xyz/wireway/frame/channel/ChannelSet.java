...
public class ChannelSet {
    ...
    public record ChannelEntry(Class<? extends xyz.wireway.frame.channel.Channel<?>> type, Object context) {}
    ...
    public <C> void register(Class<? extends Channel<C>> channel, C context) {
        xyz.wireway.frame.channel.ChannelId id = channel.getAnnotation(ChannelId.class);
