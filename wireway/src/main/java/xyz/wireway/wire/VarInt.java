...
public final class VarInt {
    ...
    /** Maximum encoded size of a 32-bit value. */
    ...
    /**
     * Like {@link #readVarInt} but restores the buffer position before throwing
     * {@link BufferUnderflowException} when the value is still incomplete.
     */
