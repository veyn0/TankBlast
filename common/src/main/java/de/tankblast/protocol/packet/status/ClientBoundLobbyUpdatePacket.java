...
@PacketId("de.tankblast.protocol.packet.status.lobbyupdate.s2c")
public class ClientBoundLobbyUpdatePacket implements Packet {

    private LobbyInfo lobbyInfo;

    public ClientBoundLobbyUpdatePacket() {
    }

    public ClientBoundLobbyUpdatePacket(LobbyInfo lobbyInfo) {
